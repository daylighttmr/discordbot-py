...
lastnames = [
    "그라시아 블랑코", "닉 켄드릭", "데이빗", "에이버리 윌리엄스", "베네 산드루", "베티 웰즈", "네이선 퍼소프", "로버트 '롭' 글렌",
    "스테파니 루비오", "니키 빅", "리코 버호벤",
    "크리스 가데니아", "밀러 제이", "로저 하워드", "가브리엘 코스타", "이노스 마셜", "벤자민 위버", "알마 던스트",
...
voices = [
    ...
    "베네 산드루: 금방 올게요",
    "알마 던스트: 이어지기만 해서는 삶이라고 할 수 없습니다. 나는 여전히 악의와 총성보다는 선의와 온기를 믿습니다. 그것이 돌아오지 않음을, 선의가 꼭 선의로 보답 되지 않음을 압니다. 폭력이 삶을 이어지게 할 수 있겠지만, 그것이 가치가 있다고 말할 수는 없습니다.", 
    "알마 던스트: ...언젠가 돌아올 겁니까?",
    "알마 던스트: 지옥은 뉴 산타바바라에 출입금지입니다만.",
    "알마 던스트: 우리는 필연적으로 만날 수 밖에 없었습니다. 내게 거부권은 없었죠.",
    "알마 던스트: 무사할 겁니다. 강한 사람이거든요. 어쩌면 라디오를 듣고 새크라멘토에 왔을지도 모르고... ... ..미국은 참 넓군요.",
    "알마 던스트: ...하하, 치졸한 인간이라는 게 이렇게 당신에게 들키는군요.",
    "알마 던스트: 당신이 어떤 삶을 살았는지 나는 모릅니다. 하지만, 평생은 당신이 죽었을 때 결정되는 거고, 앞으로 어떤 삶을 살아갈 건지는 당신이 정하는 겁니다. 원망과 후회 속에 모든 삶을 집어 넣지 마세요. 당신 스스로 평생을 결정짓게 될 겁니다.",
    "알마 던스트: 여기 얼음 빼고, 와인 뺀 차가운 거 한 잔입니다.",
    "알마 던스트: 아, 좋습니다. 당신이 준 잔을 거절할 수는 없죠.",
    "알마 던스트: 난, ..**괜찮습니다!** 신경쓰지 말고 더 빨리달리세요, 코스타!",
    "알마 던스트: 엔시, 나는 이 공동체가 가족과 다름없다고 느껴.",
    "알마 던스트: 그 아이들이 우리의 내일이 되어 줄 겁니다. 우리는 그 아이들의 기회가 될 거고요.", 
    "알마 던스트: *... ..내가 아직 당신을 믿어도 됩니까?*", 
    "알마 던스트: 금메달리스트는 한입으로 두말 안 합니다.", 
    "알마 던스트: 당신이 원하는데 당연히 같이 있어야죠. 몹시 한가합니다.", 
    "알마 던스트: 내 미래에는 당신이 있는데, 정말 가버릴 겁니까?", 
    "알마 던스트: 뭐, 딱히 일정은 없습니다만 누군가 부르면 가겠죠. 작업 거는 겁니까?", 
    "알마 던스트: 과대평가라니까.", 
    "알마 리베라: 나는 달려왔고 또다시 달릴 것입니다. 달려온 여정이 더 많은 이들에게 기회가 주어질 계기가 되었으면 합니다. 결승선은 결코 멀지 않습니다.", 
    "알마 던스트: 너무 신경 쓸 필요는 없습니다. 나는 달려왔고 또다시 달릴 테니까.",
    "가브리엘 코스타: 가브리엘이라고 불러요. 게이브, 가비, 울프. 다 상관없어요.",
    "가브리엘 코스타: 혹시 치료가 필요한 사람있다면 언제든 찾아와도 좋아.",
    "가브리엘 코스타: 코고는 소리는 어디로 항의 넣어야해?",
    "가브리엘 코스타: 난 월마트에서 일했었어. 여행하면서 돈이 필요했거든. 돈을 다 벌면 동부로 가려고 했는데... 혹시 넌 뉴욕 가본 적 있어?",
    "가브리엘 코스타: 하지만 날 도와주는 사람이 없었다면 이런 여행은 못했어. 미국 서부를 돌아다니면서 만나는 사람들은 다 좋았지. 물론 레드넥들도 있었지만 말이야. 말했다시피 여긴 시골이니까. 그리고 지금은... 좋은 사람들을 만난 것 같아. 너도.",
    "가브리엘 코스타: 당신이 새 가족을 찾으라고 했죠? 덕분에 찾은 것 같아요.",
    "가브리엘 코스타: 있잖아. 만약 네가 지켜야하는 것들과 꼭 해야만 하는 것들에서 고른다면 뭘 고를래?",
    "가브리엘 코스타: 네, 맞아요. 이해해요. 저도 피아노를 막 배웠을 때 베토벤이 엘리제를 육십 번쯤 죽였을걸요.",
    "가브리엘 코스타: 더 당하지 않게, 죽지 않게 행동해야지. 이미 벌어진 일이야. 되돌릴 수 없어.",
    "가브리엘 코스타: ...슬퍼요. 진심으로요."
